...
public enum ExceptionMessage {
    AUTHENTICATION("La autenticación fallo con los datos '%s'"),
    ENTITY_ALREADY_EXISTS("La entidad '%s' ya existe"),
    ENTITY_NOT_FOUND("La entidad '%s' con valor '%s' no fue encontrada"),
    PROPERTY_ALREADY_IN_USE("El valor '%s' ya está siendo usado por otra entidad"),
    REPORT_NOT_FOUND("No se encontró el reporte '%s'"),
    VALUE_REQUIRED("El valor no puede estar vacío");
