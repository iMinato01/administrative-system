...
public class ContractService {
    ...
    public Contract saveContract(CreateContractDTO createContractDTO){
        ValidationUtils.validateIfExists(createContractDTO.getName(), contractRepository::existsByName, ()-> new EntityAlreadyExistsException(ExceptionMessage.ENTITY_ALREADY_EXISTS.format(createContractDTO.getName())));
    ...
    public Contract updateContract(Long id, UpdateContractDTO updateContractDTO){
        ...
        ValidationUtils.validateIfExists(updateContractDTO.getName(), contractRepository::existsByName, ()-> new PropertyAlreadyInUseException(ExceptionMessage.PROPERTY_ALREADY_IN_USE.format(updateContractDTO.getName())));
